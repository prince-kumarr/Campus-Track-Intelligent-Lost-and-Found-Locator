...
const DEFAULT_IMAGE_URL =
  "https://res.cloudinary.com/do7xvxiqq/image/upload/v1759833173/Gemini_Generated_Image_vu4wr4vu4wr4vu4w_niixw0.png";
...
const LostItemSubmit = () => {
  ...
  // 🔍 Full form validation (except image)
  const validateForm = () => {
    let tempErrors = {};
            ...
            <div className="lg:col-span-3 p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  ...
                  <input
                    name="itemName"
                    className={inputStyles("itemName")}
                    value={item.itemName}
                ...
                <div>
                  ...
                  <input
                    type="date"
                    name="lostDate"
                    className={inputStyles("lostDate")}
                    value={item.lostDate}
                    onChange={onChangeHandler}
                  />
                  {errors.lostDate && (
